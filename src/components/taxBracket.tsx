          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                If you're wondering why the Federal Tax seems similar, it's because the tax bracket rates up to the $400,000(single) and $450,000(married) are the same for both presidents. 
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-400">
